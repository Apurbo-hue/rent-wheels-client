...
const BrowseCars = () => {
    ...
    const filteredCars = carsData.filter((cars) => cars.carName?.toLowerCase().includes(search.toLowerCase()))
    ...
    return (
        <div className='w-11/12 mx-auto my-4'>
            ...
            <div className='px-20 flex justify-between'>
                <h1 className='text-center font-bold'>Cars({filteredCars.length})</h1>
